...
### 7. update de mysql config en schaal de service op
...
Controleer nu opnieuw de inhoud van de tabel `ApplicationData`. **Wat zie je? Waarom?**
<details>
<summary>Antwoord en uitleg</summary>

Je zal zien dat de database en tabel nu bestaan, alsook de rij "Hello World 2". Wanneer we de service updaten, wordt er in feite een nieuwe 
</details>